...
// Virtual for birth date for database storing (YYYY-MM-DD)
AuthorSchema.virtual("database_birth").get(function () {
  return (this.date_of_birth ? DateTime.fromJSDate(this.date_of_birth).toFormat('yyyy-MM-dd') : '');
});

// Virtual for birth date for database storing (YYYY-MM-DD)
AuthorSchema.virtual("database_death").get(function () {
